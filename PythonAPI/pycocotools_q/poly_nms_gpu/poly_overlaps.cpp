...
#define __PYX_HAVE__pycocotools_q__poly_nms_gpu__poly_overlaps
#define __PYX_HAVE_API__pycocotools_q__poly_nms_gpu__poly_overlaps
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pycocotools_q.poly_nms_gpu.poly_overlaps' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "pycocotools_q.poly_nms_gpu.poly_overlaps"
extern int __pyx_module_is_main_pycocotools_q__poly_nms_gpu__poly_overlaps;
int __pyx_module_is_main_pycocotools_q__poly_nms_gpu__poly_overlaps = 0;

/* Implementation of 'pycocotools_q.poly_nms_gpu.poly_overlaps' */
...
static const char __pyx_k_pycocotools_q_poly_nms_gpu_poly[] = "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_pycocotools_q_poly_nms_gpu_poly_2[] = "pycocotools_q.poly_nms_gpu.poly_overlaps";
...
static PyObject *__pyx_pf_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_poly_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes, __pyx_t_5numpy_int32_t __pyx_v_device_id); /* proto */
...
/* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":7
...
/* Python wrapper */
static PyObject *__pyx_pw_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_1poly_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_1poly_overlaps = {"poly_overlaps", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_1poly_overlaps, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_1poly_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pycocotools_q.poly_nms_gpu.poly_overlaps.poly_overlaps", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_poly_overlaps(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes, __pyx_v_device_id);
...
static PyObject *__pyx_pf_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_poly_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes, __pyx_t_5numpy_int32_t __pyx_v_device_id) {
  int __pyx_v_N;
  int __pyx_v_K;
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":8
 * 
 * def poly_overlaps(np.ndarray[np.float32_t, ndim=2] boxes, np.ndarray[np.float32_t, ndim=2] query_boxes, np.int32_t device_id=0):
 *     cdef int N = boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int K = query_boxes.shape[0]
 ...
 */
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":9
 * def poly_overlaps(np.ndarray[np.float32_t, ndim=2] boxes, np.ndarray[np.float32_t, ndim=2] query_boxes, np.int32_t device_id=0):
 *     cdef int N = boxes.shape[0]
 *     cdef int K = query_boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=2] overlaps = np.zeros((N, K), dtype = np.float32)
 ...
 */
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":10
 *     cdef int N = boxes.shape[0]
 *     cdef int K = query_boxes.shape[0]
 *     cdef np.ndarray[np.float32_t, ndim=2] overlaps = np.zeros((N, K), dtype = np.float32)             # <<<<<<<<<<<<<<
 *     _overlaps(&overlaps[0, 0], &boxes[0, 0], &query_boxes[0, 0], N, K, device_id)
 ...
 */
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":11
 *     cdef int K = query_boxes.shape[0]
 *     cdef np.ndarray[np.float32_t, ndim=2] overlaps = np.zeros((N, K), dtype = np.float32)
 *     _overlaps(&overlaps[0, 0], &boxes[0, 0], &query_boxes[0, 0], N, K, device_id)             # <<<<<<<<<<<<<<
 *     return overlaps
 ...
 */
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":12
 *     cdef np.ndarray[np.float32_t, ndim=2] overlaps = np.zeros((N, K), dtype = np.float32)
 *     _overlaps(&overlaps[0, 0], &boxes[0, 0], &query_boxes[0, 0], N, K, device_id)
 *     return overlaps             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pycocotools_q_poly_nms_gpu_poly, __pyx_n_s_poly_overlaps, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pycocotools_q__poly_nms_gpu__poly_overlaps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pycocotools_q.poly_nms_gpu.poly_overlaps")) {
      if (unlikely(PyDict_SetItemString(modules, "pycocotools_q.poly_nms_gpu.poly_overlaps", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pycocotools_q/poly_nms_gpu/poly_overlaps.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
 ...
 *     cdef int K = query_boxes.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13pycocotools_q_12poly_nms_gpu_13poly_overlaps_1poly_overlaps, NULL, __pyx_n_s_pycocotools_q_poly_nms_gpu_poly_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pycocotools_q.poly_nms_gpu.poly_overlaps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pycocotools_q.poly_nms_gpu.poly_overlaps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
